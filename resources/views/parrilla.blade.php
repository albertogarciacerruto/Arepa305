...
<body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div class="row">
      <div class="col-md-6">
        <form class="container" action="{{ url('parrilla') }}" method="POST" enctype="multipart/form-data">
          {{ csrf_field() }}
            
            <h2> Parrilla #1 </h2>
            <div class="custom-file">
                <input type="file" name="image_f43" class="custom-file-input" id="image_f43">
      ...
      <div class=" col-md-6">
          <div class="container">
            <h2> Parrilla #2 </h2>
            <div class="custom-file">
                <input type="file" name="image_f44" class="custom-file-input" id="image_f44">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
    ...
    <div class="row">
      <div class="col-md-6">
          <div class="container">
            <h2> Parrilla #3 </h2>
            <div class="custom-file">
                <input type="file" name="image_f45" class="custom-file-input" id="image_f45">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
      ...
      <div class=" col-md-6">
          <div class="container">
            <h2> Parrilla #4 </h2>
            <div class="custom-file">
                <input type="file" name="image_f46" class="custom-file-input" id="image_f46">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
    ...
    <div class="row">
      <div class="col-md-6">
          <div class="container">
            <h2> Parrilla #5 </h2>
            <div class="custom-file">
                <input type="file" name="image_f47" class="custom-file-input" id="image_f47">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
      ...
      <div class=" col-md-6">
          <div class="container">
            <h2> Parrilla #6 </h2>
            <div class="custom-file">
                <input type="file" name="image_f48" class="custom-file-input" id="image_f48">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
