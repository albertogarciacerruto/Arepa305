...
<body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div class="row">
      <div class="col-md-6">
        <form class="container" action="{{ url('desayuno') }}" method="POST" enctype="multipart/form-data">
          {{ csrf_field() }}
            
            <h2> Desayuno #1 </h2>
            <div class="custom-file">
                <input type="file" name="image_f7" class="custom-file-input" id="image_f7">
      ...
      <div class=" col-md-6">
          <div class="container">
            <h2> Desayuno #2 </h2>
            <div class="custom-file">
                <input type="file" name="image_f8" class="custom-file-input" id="image_f8">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
    ...
    <div class="row">
      <div class="col-md-6">
          <div class="container">
            <h2> Desayuno #3 </h2>
            <div class="custom-file">
                <input type="file" name="image_f9" class="custom-file-input" id="image_f9">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
      ...
      <div class=" col-md-6">
          <div class="container">
            <h2> Desayuno #4 </h2>
            <div class="custom-file">
                <input type="file" name="image_f10" class="custom-file-input" id="image_f10">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
    ...
    <div class="row">
      <div class="col-md-6">
          <div class="container">
            <h2> Desayuno #5 </h2>
            <div class="custom-file">
                <input type="file" name="image_f11" class="custom-file-input" id="image_f11">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
      ...
      <div class=" col-md-6">
          <div class="container">
            <h2> Desayuno #6 </h2>
            <div class="custom-file">
                <input type="file" name="image_f12" class="custom-file-input" id="image_f12">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
