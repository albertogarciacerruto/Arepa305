...
<body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div class="row">
      <div class="col-md-6">
        <form class="container" action="{{ url('arepa') }}" method="POST" enctype="multipart/form-data">
          {{ csrf_field() }}
            
            <h2> Arepa #1 </h2>
            <div class="custom-file">
                <input type="file" name="image_f1" class="custom-file-input" id="image_f1">
    ...
    <div class="row">
      <div class="col-md-6">
          <div class="container">
            <h2> Arepa #3 </h2>
            <div class="custom-file">
                <input type="file" name="image_f3" class="custom-file-input" id="image_f3">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
      ...
      <div class=" col-md-6">
          <div class="container">
            <h2> Arepa #4 </h2>
            <div class="custom-file">
                <input type="file" name="image_f4" class="custom-file-input" id="image_f4">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
    ...
    <div class="row">
      <div class="col-md-6">
          <div class="container">
            <h2> Arepa #5 </h2>
            <div class="custom-file">
                <input type="file" name="image_f5" class="custom-file-input" id="image_f5">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
      ...
      <div class=" col-md-6">
          <div class="container">
            <h2> Arepa #6 </h2>
            <div class="custom-file">
                <input type="file" name="image_f6" class="custom-file-input" id="image_f6">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
