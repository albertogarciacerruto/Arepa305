...
<html lang="en">
  ...
  <head>
    ...
    <title>AREPA305 | Panel De Control</title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.html">Areapa 305</a>
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="container d-flex justify-content-center" style="height: 200px">
            <img src="../public/img/305/logo.png" style="width: 200px" style="height:200px">
          </div>
