...
<body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div class="row">
      <div class="col-md-12">
        <form class="container" action="{{ url('galeria') }}" method="POST" enctype="multipart/form-data">
          {{ csrf_field() }}
            
            <h2> Titulo</h2>
            <input type="text" class="form-control" name="title" id="title" maxlength="100" value="{{$title[0]->title}}">
          </div>
       </div>
    <br>
