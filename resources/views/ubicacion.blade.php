...
<body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div class="row">
      <div class="col-md-6">
        <form class="container" action="{{ url('ubicacion') }}" method="POST" enctype="multipart/form-data">
          {{ csrf_field() }}
      ...
      <div class="col-md-6">
          <div class="container">
            <h2> Telefono </h2>
            <input type="text" class="form-control" name="phone" id="phone" maxlength="16" value="{{$phone[0]->phone}}">
            <br>
            <br>
          </div>
      </div>
     ...
     <div class="row">
      <div class=" col-md-6">
          <div class="container">
            ...
            <input type="text" class="form-control" name="email" id="email" maxlength="100" value="{{$email[0]->email}}">
            <br>
          </div>
      </div>
      <div class=" col-md-6">
          <div class="container">
            <h2> Direción </h2>
            <input type="text" class="form-control" name="address" id="address" maxlength="100" value="{{$address[0]->address}}">
            <br>
          </div>
      </div>
    </div>
    <br>
     <div class="row">
      <div class=" col-md-6">
          <div class="container">
            <h2> Horario Lunes - Viernes </h2>
            <input type="text" class="form-control" name="horario1" id="horario1" maxlength="100" value="{{$horario1[0]->horario1}}">
            <br>
          </div>
      </div>
      <div class=" col-md-6">
          <div class="container">
            <h2> Horario Sabados </h2>
            <input type="text" class="form-control" name="horario2" id="horario2" maxlength="100" value="{{$horario2[0]->horario2}}">
            <br>
          </div>
      </div>
    </div>
    <br>
     <div class="row">
      <div class=" col-md-6">
          <div class="container">
            <h2> Horario Domingos </h2>
            <input type="text" class="form-control" name="horario3" id="horario3" maxlength="100" value="{{$horario3[0]->horario3}}">
            <br>
          </div>
      </div>
      <div class=" col-md-6">
          <div class="container">
            <h2> Imagen de Fondo de la Secciòn </h2>
            <div class="custom-file">
              <input type="file" name="image_f2" class="custom-file-input" id="image_f2">
