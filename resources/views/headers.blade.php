...
<html lang="es">
  ...
  <head>
    ...
    <title>Arepa305 | Sección Principal</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        ...
        <div class="row">
        <div class="col-md-6">
          <form class="container" action="{{ url('headers') }}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
        ...
        <div class="col-md-6">
            <div class="container">
              <h2> Logo</h2>
              <div class="custom-file">
                <input type="file" name="image_lg" class="custom-file-input" id="image_lg">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
              <br>
        ...
        <div class="row">
           ...
           <div class=" col-md-6">
              <div class="container">
                <h2> Descripcion </h2>
                <textarea class="form-control" name="descripcion" id="descripcion" rows="3">{{$descripcion[0]->descripcion}}</textarea>
              </div>
           </div>
        </div>
        <br>
