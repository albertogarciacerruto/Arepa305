...
<body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div class="row">
      <div class="col-md-6">
        <form class="container" action="{{ url('pepito') }}" method="POST" enctype="multipart/form-data">
          {{ csrf_field() }}
            
            <h2> Pepito #1 </h2>
            <div class="custom-file">
                <input type="file" name="image_f37" class="custom-file-input" id="image_f37">
      ...
      <div class=" col-md-6">
          <div class="container">
            <h2> Pepito #2 </h2>
            <div class="custom-file">
                <input type="file" name="image_f38" class="custom-file-input" id="image_f38">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
    ...
    <div class="row">
      <div class="col-md-6">
          <div class="container">
            <h2> Pepito #3 </h2>
            <div class="custom-file">
                <input type="file" name="image_f39" class="custom-file-input" id="image_f39">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
      ...
      <div class=" col-md-6">
          <div class="container">
            <h2> Pepito #4 </h2>
            <div class="custom-file">
                <input type="file" name="image_f40" class="custom-file-input" id="image_f40">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
    ...
    <div class="row">
      <div class="col-md-6">
          <div class="container">
            <h2> Pepito #5 </h2>
            <div class="custom-file">
                <input type="file" name="image_f41" class="custom-file-input" id="image_f41">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
      ...
      <div class=" col-md-6">
          <div class="container">
            <h2> Pepito #6 </h2>
            <div class="custom-file">
                <input type="file" name="image_f42" class="custom-file-input" id="image_f42">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
