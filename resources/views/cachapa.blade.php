...
<body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div class="row">
      <div class="col-md-6">
        <form class="container" action="{{ url('cachapa') }}" method="POST" enctype="multipart/form-data">
          {{ csrf_field() }}
            
            <h2> Cachapa #1 </h2>
            <div class="custom-file">
                <input type="file" name="image_f13" class="custom-file-input" id="image_f13">
      ...
      <div class=" col-md-6">
          <div class="container">
            <h2> Cachapa #2 </h2>
            <div class="custom-file">
                <input type="file" name="image_f14" class="custom-file-input" id="image_f14">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
    ...
    <div class="row">
      <div class="col-md-6">
          <div class="container">
            <h2> Cachapa #3 </h2>
            <div class="custom-file">
                <input type="file" name="image_f15" class="custom-file-input" id="image_f15">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
      ...
      <div class=" col-md-6">
          <div class="container">
            <h2> Cachapa #4 </h2>
            <div class="custom-file">
                <input type="file" name="image_f16" class="custom-file-input" id="image_f16">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
    ...
    <div class="row">
      <div class="col-md-6">
          <div class="container">
            <h2> Cachapa #5 </h2>
            <div class="custom-file">
                <input type="file" name="image_f17" class="custom-file-input" id="image_f17">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
      ...
      <div class=" col-md-6">
          <div class="container">
            <h2> Cachapa #6 </h2>
            <div class="custom-file">
                <input type="file" name="image_f18" class="custom-file-input" id="image_f18">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
