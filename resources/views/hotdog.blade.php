...
<body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div class="row">
      <div class="col-md-6">
        <form class="container" action="{{ url('hotdog') }}" method="POST" enctype="multipart/form-data">
          {{ csrf_field() }}
            
            <h2> Hot Dog #1 </h2>
            <div class="custom-file">
                <input type="file" name="image_f25" class="custom-file-input" id="image_f25">
      ...
      <div class=" col-md-6">
          <div class="container">
            <h2> Hot Dog #2 </h2>
            <div class="custom-file">
                <input type="file" name="image_f26" class="custom-file-input" id="image_f26">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
    ...
    <div class="row">
      <div class="col-md-6">
          <div class="container">
            <h2> Hot Dog #3 </h2>
            <div class="custom-file">
                <input type="file" name="image_f27" class="custom-file-input" id="image_f27">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
      ...
      <div class=" col-md-6">
          <div class="container">
            <h2> Hot Dog #4 </h2>
            <div class="custom-file">
                <input type="file" name="image_f28" class="custom-file-input" id="image_f28">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
    ...
    <div class="row">
      <div class="col-md-6">
          <div class="container">
            <h2> Hot Dog #5 </h2>
            <div class="custom-file">
                <input type="file" name="image_f29" class="custom-file-input" id="image_f29">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
      ...
      <div class=" col-md-6">
          <div class="container">
            <h2> Hot Dog #6 </h2>
            <div class="custom-file">
                <input type="file" name="image_f30" class="custom-file-input" id="image_f30">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
