...
<html lang="es">
  ...
  <head>
    ...
    <title>Arepa305 | Lista De Usuarios</title>
    ...
    <div id="wrapper">
      ...
      <div class="container">
        <div class="card card-register mx-auto mt-5">
          <div class="card-header d-flex justify-content-center"><strong>Usuarios Del Sistema</strong></div>
          <div class="panel-body">
              <table class="table table-striped">
                <thead>
                  <tr>
                    <th scope="col-4" class="text-center">Nombre</th>
                    <th scope="col-4" class="text-center">Apellido</th>
                ...
                <tbody>
                  ...
                  <tr>
                    <th scope="col-4" class="text-center">{{ $user->name }}</th>
                    <td scope="col-4" class="text-center">{{ $user->lastname}}</td>
                    <td scope="col-4" class="text-center"><a class="btn btn-danger"  href="{{url('list_users', $user->id)}}">Eliminar</a></td>
                  </tr>
                   @endforeach
                </tbody>
              </table>  
