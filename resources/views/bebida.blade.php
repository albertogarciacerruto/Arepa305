...
<body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div class="row">
      <div class="col-md-6">
        <form class="container" action="{{ url('bebida') }}" method="POST" enctype="multipart/form-data">
          {{ csrf_field() }}
            
            <h2> Bebida #1 </h2>
            <div class="custom-file">
                <input type="file" name="image_f55" class="custom-file-input" id="image_f55">
      ...
      <div class=" col-md-6">
          <div class="container">
            <h2> Bebida #2 </h2>
            <div class="custom-file">
                <input type="file" name="image_f56" class="custom-file-input" id="image_f56">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
    ...
    <div class="row">
      <div class="col-md-6">
          <div class="container">
            <h2> Bebida #3 </h2>
            <div class="custom-file">
                <input type="file" name="image_f57" class="custom-file-input" id="image_f57">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
      ...
      <div class=" col-md-6">
          <div class="container">
            <h2> Bebida #4 </h2>
            <div class="custom-file">
                <input type="file" name="image_f58" class="custom-file-input" id="image_f58">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
    ...
    <div class="row">
      <div class="col-md-6">
          <div class="container">
            <h2> Bebida #5 </h2>
            <div class="custom-file">
                <input type="file" name="image_f59" class="custom-file-input" id="image_f59">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
      ...
      <div class=" col-md-6">
          <div class="container">
            <h2> Bebida #6 </h2>
            <div class="custom-file">
                <input type="file" name="image_f60" class="custom-file-input" id="image_f30">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
