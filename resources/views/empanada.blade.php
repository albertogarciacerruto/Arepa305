...
<body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div class="row">
      <div class="col-md-6">
        <form class="container" action="{{ url('empanada') }}" method="POST" enctype="multipart/form-data">
          {{ csrf_field() }}
            
            <h2> Empanada #1 </h2>
            <div class="custom-file">
                <input type="file" name="image_f31" class="custom-file-input" id="image_f31">
      ...
      <div class=" col-md-6">
          <div class="container">
            <h2> Empanada #2 </h2>
            <div class="custom-file">
                <input type="file" name="image_f32" class="custom-file-input" id="image_f32">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
    ...
    <div class="row">
      <div class="col-md-6">
          <div class="container">
            <h2> Empanada #3 </h2>
            <div class="custom-file">
                <input type="file" name="image_f33" class="custom-file-input" id="image_f33">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
      ...
      <div class=" col-md-6">
          <div class="container">
            <h2> Empanada #4 </h2>
            <div class="custom-file">
                <input type="file" name="image_f34" class="custom-file-input" id="image_f34">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
    ...
    <div class="row">
      <div class="col-md-6">
          <div class="container">
            <h2> Empanada #5 </h2>
            <div class="custom-file">
                <input type="file" name="image_f35" class="custom-file-input" id="image_f35">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
      ...
      <div class=" col-md-6">
          <div class="container">
            <h2> Empanada #6 </h2>
            <div class="custom-file">
                <input type="file" name="image_f36" class="custom-file-input" id="image_f36">
                <label class="custom-file-label" for="validatedCustomFile">Ingresa Imagen</label>
                <div class="invalid-feedback">Error</div>
              </div>
            <br>
